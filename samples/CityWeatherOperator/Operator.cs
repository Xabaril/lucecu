...
namespace CityWeatherOperator
{
    ...
    {
        private Watcher<CityWeatherResource> _watcher;

        private readonly Channel<WatchData> _channel;

        private readonly CancellationTokenSource _stoppingCts = new CancellationTokenSource();
        private readonly IKubernetes _kubernetesClient;
        private readonly ICityWeatherOperatorController _controller;
        private readonly OperatorDiagnostics _diagnostics;

        public Operator(
            IKubernetes kubernetesClient,
            ICityWeatherOperatorController controller,
        ...
        private Task StartWatcher(CancellationToken cancellationToken)
        {
            ...
            _watcher = response.Watch<CityWeatherResource, object>(
        ...
        private class WatchData
        {
            ...
            public CityWeatherResource Resource { get; set; }
        }
    }
}
